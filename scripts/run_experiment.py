"""Run an experiment: multiple prompts through one model with full configuration."""
...
def main():
    ...
    parser.add_argument("--experiment-id", default="experiment-v1", help="Experiment ID")
    ...
    parser.add_argument("--constrained", action="store_true", help="Use constrained decoding")
